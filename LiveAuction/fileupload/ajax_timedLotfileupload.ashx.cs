...
namespace LiveAuction.fileupload
{
    ...
    /// </summary>
    public class ajax_timedLotfileupload : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            string dirFullPath = HttpContext.Current.Server.MapPath("~/fileupload/timedLots/");
            ...
            else
            {
                ...
                foreach (string s in context.Request.Files)
                {
                    ...
                    if (!string.IsNullOrEmpty(fileName))
                    {
                        ...
                        string pathToSave_100 = HttpContext.Current.Server.MapPath("~/fileupload/timedLots/") + str_image;
