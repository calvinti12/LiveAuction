    ...
    public partial class CatDisplay : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Category != null && !Category.Equals(""))
            {
                ...
                else if (Category.Equals("AllDeals"))
                {
                    PopulateDeals();
                }
                else
        ...
        public void PopulateItems(string id)
        {
            ...
            {
                template += @"<li><a href='CatDisplay.aspx?cat=AllAuctions&id=" + dt.Rows[i]["CategoryId"] + "'>" + dt.Rows[i]["CategoryName"] + "</a></li>";
            }
        ...
        public void PopulateAuctions()
        {
            ...
            SqlConnection con = new SqlConnection(connectionString);
            con.Open();
            string query = "  select CategoryId,CategoryName,CategoryDesc,ParentId from dbo.ProductCategory where ParentId is null";
            string allAuctionsQuery = "  select AuctionId,LotId,LotDesc,CategoryId,Title,StartingBid,AuctionName,AuctionDate,AuctionTime,[Address],LotImageName,ImageName from dbo.View_list_item where IsSchedule=1";
        ...
        public void PopulateAuctions(string id)
        {
            ...
            SqlConnection con = new SqlConnection(connectionString);
            con.Open();
            string query = "Select * from dbo.View_ProductAuction_Category where Categoryid="+id+"";
        ...
        public void PopulateDeals()
        {
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                template += @"<li><a href='#'>" + dt.Rows[i]["CategoryName"] + "</a></li>";
            }
