...
namespace LiveAuction.Admin
{
    public partial class live_auction_admin : System.Web.UI.Page
    {
        ...
        {
            userName = Convert.ToString(HttpContext.Current.Session["AdminUserName"]).Trim();
        ...
        public static string WriteToLog(string id)
        {
            ...
            if (userName != null && userName != "")
            {
                ...
                AddtoLogFile("Room bid £", "sampleWebsite", "lotNo_" + id, askingBidPrice, id);
                UpdateFairWarning(id);
                return "Room bid £" + askingBidPrice;
            }
            else
