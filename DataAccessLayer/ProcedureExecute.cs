...
namespace DataAccessLayer
{
    ...
    public class ProcedureExecute : IDisposable
    {
        ...
        private void InitQuery(SqlCommand oCmd)
        {
            ...
            if (blnLocalConn)
            {
                string conn = System.Configuration.ConfigurationSettings.AppSettings["ConnStr"]; //System.Configuration.ConfigurationManager.ConnectionStrings["ConnStr"].ToString();
                Open(conn);
                blnLocalConn = true;
            }
